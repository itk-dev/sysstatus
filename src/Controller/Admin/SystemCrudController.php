...
class SystemCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        if (Crud::PAGE_INDEX === $pageName) {
            ...
            return [$name, $text, $sys_owner, $sys_view_all_groups, $answers, $sys_title, $id, $edoc_url, $sys_id_as_link,
                $sys_updated, $sys_description, $sys_system_owner, $sys_owner_subdepartment, $sys_emergency_setup, $sys_contractor,
                $sys_urgency_rating, $sys_number_of_users, $sys_technical_documentation, $sys_technical_documentation, $sys_important_information,
                $sys_superuser_organization, $sys_itsecurity_category, $sys_link_to_security_review, $sys_link_to_contract, $sys_end_of_contract,
